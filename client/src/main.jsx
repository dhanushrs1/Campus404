...
import { applyDocumentSiteSettings, fetchPublicSiteSettings } from './utils/siteSettings'
...
fetchPublicSiteSettings()
  .then((settings) => {
    applyDocumentSiteSettings(settings);
  })
  .catch(() => {
    // Keep fallback title/favicon from index.html when settings API is unavailable.
  });

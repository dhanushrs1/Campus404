...
export const ASSETS = Object.freeze({
  ...
  icons: {
    ...
    leaderboardRankingCardFrameBronze: publicAsset("icons/leaderboard-ranking-card-frame-bronze.svg"),
    leaderboardRankingCardFrame: publicAsset("icons/leaderboard-ranking-card-frame.svg"),
    leaderboardRankingCardFrameSilver: publicAsset("icons/leaderboard-ranking-card-frame-silver.svg"),
